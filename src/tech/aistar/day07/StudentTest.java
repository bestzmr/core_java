...
public class StudentTest {
    public static void main(String[] args) {
        ...
        System.out.println(s);//tech.aistar.day07.Student@330bedb4

        //多次修改属性

        //可以在外界直接操作对象的属性 - 非常不推荐,也是非常不安全的.
        //不利于程序的可维护性.操作的系统都直接公布了.没有进行屏蔽.
        s.id = 100;
        s.id = 200;
        ...
        System.out.println(s.clazz);//null

        System.out.println("====华丽丽的分割线====");
        //yy->创建一个特殊的"数组"[存放不同类型的多条数据]
